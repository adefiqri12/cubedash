...
void setup(){
  ...
  backgroundMusic = new SoundFile(this, "bgm.wav"); 
  backgroundMusic.amp(0.25); //controls the volume, 0.25 = 25 %
  backgroundMusic.play();
  
  //initialising death noise
  deathNoise = new SoundFile(this, "DeathNoise.wav");
...
void draw(){
  ...
  //obstacles
  for(int i = 0; i < 300; i++){
    obstacles[i].move(11); //initialises the move speed for all obstacles
  }
